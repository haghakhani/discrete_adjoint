...
//		char filename[50];
//		sprintf(filename,"dual_%d_%d",timeprops_ptr->iter,myid);
//		write_alldualdata_ordered(Dual_El_Tab, filename);
//		write_elem_sorted(Dual_El_Tab,filename);
