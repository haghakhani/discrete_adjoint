...
double get_coef_and_eigen(HashTable* El_Table, HashTable* NodeTable,
		MatProps* matprops_ptr, FluxProps* fluxprops_ptrs, TimeProps* timeprops_ptr,
		int ghost_flag);
...
void save_solution(HashTable* El_Table, HashTable* NodeTable,
		HashTable* solHystPtr, TimeProps* timeprops_ptr);
...
void record_flux(HashTable* El_Table, HashTable* NodeTable, unsigned* key,
		MatProps* matprops_ptr, int effelement, int myid, double fluxxpold[4],
		double fluxypold[4], double fluxxmold[4], double fluxymold[4]);

void flux_debug(Element* Curr_El, double fluxxpold[4], double fluxxmold[4],
		double fluxypold[4], double fluxymold[4], double fluxxp[4],
		double fluxxm[4], double fluxyp[4], double fluxym[4], int effelement, int j,
		int iter, double dt);
...
void find_adjoint_sol(HashTable* El_Table, vector<Jacobian*>* solHyst,
		PertElemInfo* eleminfo, TimeProps* timeprops_ptr);

void fill_pertelem_info(HashTable* El_Table, vector<Jacobian*>* solHyst,
