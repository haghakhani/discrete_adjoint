...
void unrefine(HashTable* El_Table, HashTable* NodeTable, double target,
		int myid, int nump, TimeProps* timeprops_ptr, MatProps* matprops_ptr,int rescomp);
...
void delete_unused_elements_nodes(HashTable* HT_Elem_Ptr,
...
int update_topo(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid,
		int nump, MatProps* matprops, TimeProps* timeprops, MapNames* mapnames);
...
extern void Read_data(int imat, MatProps* matprops_ptr,
		PileProps* pileprops_ptr, StatProps* statprops_ptr,
		TimeProps* timeprops_ptr, FluxProps *fluxprops, int* adaptflag_ptr,
		int* viz_flag_ptr, int* order_flag_ptr, MapNames* mapnames_ptr,
		DISCHARGE* discharge_ptr, OutLine* outline_ptr, int *srctype);
...
extern void Read_grid(int myid, int numprocs, HashTable** NodeTable,
...
extern int loadrun(int myid, int numprocs, HashTable** NodeTable,
		HashTable** ElemTable, MatProps* matprops_ptr, TimeProps* timeprops_ptr,
		MapNames *mapnames_ptr, int *adaptflag_ptr, int *order_flag_ptr,
...
extern void saverun(HashTable** NodeTable, int myid, int numprocs,
		HashTable** ElemTable, MatProps* matprops_ptr, TimeProps* timeprops_ptr,
		MapNames *mapnames_ptr, int adaptflag, int order_flag,
		StatProps *statprops_ptr, DISCHARGE *discharge_ptr, OutLine* outline_ptr,
		int *savefileflag);
...
extern void init_piles(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid,
		int numprocs, int adaptflag, MatProps* matprops, TimeProps* timeprops,
		MapNames* mapnames, PileProps* pileprops, FluxProps* fluxprops,
		StatProps* statprops);
...
extern void IncorporateNewElements(HashTable* El_Table, HashTable* NodeTable,
		int myid, int num_recv, ElemPack *recv_array, TimeProps* timeprops_ptr);
...
extern void tecplotter(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr,
		MatProps* matprops, TimeProps* timeprops, MapNames* mapnames, double v_star,
		int adjflag);
...
void viz_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid,
		int numprocs, MatProps* matprops, TimeProps* timeprops, MapNames* mapnames);
...
int write_xdmf(HashTable *El_Table, HashTable *NodeTable,
		TimeProps *timeprops_ptr, MatProps *matprops_ptr, MapNames *mapnames,
		const int mode);
...
void incr_tri_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid,
		int numprocs, MatProps* matprops, TimeProps* timeprops, double v_star);
...
void web_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr, int myid,
		double time, int numprocs, MatProps* matprops, TimeProps* timeprops);
//! this is one of the small output file size functions, this output format is meant for use with a web browser based viewer, this is now out of date.
...
void grass_sites_proc_output(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr,
		int myid, MatProps* matprops, TimeProps* timeprops);
...
//! this function is legacy, it is not defined in the finite difference/volume version of titan
extern void search_object(HashTable* HT_Elem_Ptr, HashTable* HT_Node_Ptr,
		unsigned* key, int myid);
...
//! this function is legacy, it is not defined in the finite difference/volume version of titan
extern void Assemble_bubble(int, int, int, int, double*, int*, HashTable*,
		HashTable*, int);

//! this function is legacy, it is not defined in the finite difference/volume version of titan
extern int make_block(int, int**, int**, int**, int**, int*, int*, HashTable*,
